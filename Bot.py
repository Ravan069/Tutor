...
def proceededQuery(prompt:str):
    ...
    Note: Follow the instruction strictly, being a "tutor" you have to be calm and be able to communicate to them as soft as possible and for the better understanding refer {st.session_state.messages}"""
        )
